...
export default function LifestylePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-green-100/30 to-pink-50 relative">
      {/* Full-coverage green glass morphism overlay */}
      <div className="fixed inset-0 bg-gradient-to-br from-green-100/40 via-green-200/30 to-green-50/50 backdrop-blur-sm pointer-events-none z-0"></div>
